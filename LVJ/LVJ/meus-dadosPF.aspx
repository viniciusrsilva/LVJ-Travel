<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="meus-dadosPF.aspx.cs" Inherits="LVJ.informacoes_clientePF" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="Estilos/informacoes-clientePF.css">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-6">
                                ...
                                <input type="text" id="txtNome" runat="server" class="form-control" disabled>
                            </div>

                            <div class="form-group col-6">
                                <label for="txtSobrenome">Sobrenome:</label>
                                <input type="text" id="txtSobrenome" runat="server" class="form-control" disabled>
                            </div>

                            <div class="form-group col-6">
                                <label for="txtNascimento">Data de Nascimento:</label>
                                <input type="text" id="txtNascimento" runat="server" dataformatstring="{0:dd/MM/yyyy}" class="form-control" disabled>
                            </div>
                            ...
                            <div class="form-group col-6">
                                ...
                                <input type="text" id="txtCPF" runat="server" class="form-control" disabled>
                            </div>

                            <div class="form-group col-6">
                                <label for="txtRG">RG:</label>
                                <input type="text" id="txtRG" runat="server" class="form-control" disabled>
                            </div>

                            <div class="form-group col-6">
                                <label for="lblTelefone">Telefone:</label>
                                <input type="text" id="txtTelefone" class="form-control" runat="server" />
                            </div>

                            <div class="form-group col-6">
                                <label for="lblCelular">Celular:</label>
                                <input type="text" id="txtCelular" class="form-control" runat="server" />
                            </div>
                        </div>
                        <p>
                            Pela sua segurança, nome, sobrenome, data de nascimento, CPF e RG não podem ser alterados.
                            <br />
