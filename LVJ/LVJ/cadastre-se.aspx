<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cadastre-se.aspx.cs" Inherits="LVJ.cadastre_se" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="Estilos/cadastre-se.css">
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <p id="pOpcao">Escolha uma opção para continuar:​</p>
        </div>

        <div class="container" id="tipoPessoa">
            <div class="box">
                <a id="btnPF" href="cadastroPF.aspx" class="btn btn-dark" role="button">Pessoa Física</a>
                <a id="btnPJ" href="cadastroPJ.aspx" class="btn btn-dark" role="button">Pessoa Jurídica</a>
            </div>
        </div>
